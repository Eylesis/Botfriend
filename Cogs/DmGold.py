...
class DMGold():
    ...
    async def dmgold(self, ctx, multiplier : int, charLevels : str, override : bool = False):
        ...
        if multiplier < 30 or multiplier > 70 and not override:
            return self.bot.say(
        ...
        individualGold = totalGold / len(goldTotals)
        
        # Build embed
        embed = discord.Embed(title="Gold Rewards", description="Gold has been calculated as per the formula `GP = (30-70)e^(0.44 * Level) / (Prof+1)`")
