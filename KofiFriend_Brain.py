...
async def tba_handler(request):
    ...
    embed = discord.Embed(
        ...
        description="{} has given ${} to the cause! The donation is appreciated!".format(data['data']['from_name'], data['data']]'amount']), timestamp=datetime.datetime.fromisoformat(data['data']['timestamp']))
